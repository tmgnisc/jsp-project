...
<body class="bg-gray-100">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <form action="${pageContext.request.contextPath}/attractions" method="post" style="display:inline;">
    ...
    <div id="attractionModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full">
        <div class="relative top-20 mx-auto p-5 border w-[600px] shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <form id="attractionForm" action="${pageContext.request.contextPath}/attractions" method="post" enctype="multipart/form-data" class="space-y-4">
    ...
    <script>
        ...
        function showEditAttractionModal(id) {
            ...
            fetch('${pageContext.request.contextPath}/attractions?action=getAttraction&id=' + id)
                .then(response => {
                    if (!response.ok) {
        ...
        function deleteAttraction(id) {
            if (confirm('Are you sure you want to delete this attraction?')) {
                fetch('${pageContext.request.contextPath}/attractions', {
                    method: 'POST',
                    headers: {
