            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-gray-500">Loot</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
                ...
                <div class="space-y-4">
                    <div class="relative h-96 rounded-lg overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1536440136628-849c177e76a1?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
                             alt="Loot" 
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        <img src="https://images.unsplash.com/photo-1536440136628-849c177e76a1?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80" 
                             alt="Loot" 
                ...
                <div class="space-y-6">
                    <div>
                        <h1 class="text-3xl font-bold text-[#002B5B]">Loot</h1>
                        <div class="flex items-center mt-2">
                            ...
                            <span class="text-gray-600 ml-2">5.0 (200 reviews)</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-gray-600 mt-2">
                                Loot is a 2012 Nepali comedy film directed by Nischal Basnet. The film follows the story of four friends who plan a bank robbery to solve their financial problems. The movie was a commercial success and is considered one of the best Nepali films of all time.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2 space-y-2">
                                <div class="flex items-center text-gray-600">
                                    ...
                                    <span>Director: Nischal Basnet</span>
                                </div>
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-calendar w-6"></i>
                                    <span>Release Year: 2012</span>
                                </div>
                                <div class="flex items-center text-gray-600">
                                ...
                                <div class="flex items-center text-gray-600">
                                    ...
                                    <span>Genre: Comedy, Crime</span>
                                </div>
                            </div>
                        </div>

                        <div>
                            <h2 class="text-xl font-semibold text-[#002B5B]">Cast</h2>
                            <ul class="list-disc list-inside text-gray-600 mt-2">
                                <li>Dayahang Rai</li>
                                <li>Saugat Malla</li>
                                <li>Karma Shakya</li>
                                <li>Srijana Subba</li>
                                <li>Deepak Chhetri</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 mt-1">
                                One of the best Nepali movies I've ever watched! The comedy timing is perfect and the story keeps you engaged throughout.
                            </p>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 mt-1">
                                The performances by Dayahang Rai and Saugat Malla are outstanding. This movie set a new standard for Nepali cinema.
                            </p>
                            <div class="flex items-center space-x-4 mt-2">
                                <button class="text-gray-500 hover:text-[#F4A300]">
                                    <i class="far fa-thumbs-up"></i> Like
